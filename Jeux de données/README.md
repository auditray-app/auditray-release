...
> Le référentiel collaboratif national (jeux réels anonymisés, données synthétiques, cas hors tolérances, scripts d'analyse) est hébergé à la **racine du dépôt** — voir [README principal](../README.md).
